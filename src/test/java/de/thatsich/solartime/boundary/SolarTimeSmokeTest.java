...
class SolarTimeSmokeTest {
    ...
    void setupSolarTime() {
        ...
        final ThrowableAssert.ThrowingCallable solarTime = () -> new SolarTime(dawnCalculator, duskCalculator, solarNoonCalculator);

        Assertions.assertThatCode(solarTime)
